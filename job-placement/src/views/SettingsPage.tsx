import { Container, Row, Col, Form, FormControl, FormLabel, Button, Alert, Modal, Toast, ToastContainer } from "react-bootstrap";
    ...
    return(
        <Container fluid className="profile-container mt-4">
          ...
          <Row>
            <Col md={6}>
              <Form>
                {!editName && <Form.Group as={Row} className="mb-3" controlId="inputName">
                  ...
                  <Col sm={8}>
                    <div className="d-flex align-items-center">
                      ...
                      <Button variant="primary" size="sm" className="ms-2" onClick={() => {setEditName(true)}}>
                        Edit
                      </Button>
                    </div>
                  </Col>
                ...
                {editName && <Form.Group as={Row} className="mb-3" controlId="inputName">
                  ...
                  <Col sm={8}>
                    <div className="d-flex align-items-center">
                      ...
                      <Button variant="danger" size="sm" className="ms-2" onClick={() => {setName(me.name); setEditName(false);}}>
                        Cancel
                      </Button>
                    </div>
                  </Col>
                ...
                {!editSurname && <Form.Group as={Row} className="mb-3" controlId="inputName">
                  <FormLabel column sm={4}>
                    Surname:
                  </FormLabel>
                  ...
                  <Col sm={8}>
                    <div className="d-flex align-items-center">
                      ...
                      <Button variant="primary" size="sm" className="ms-2" onClick={() => {setEditSurname(true)}}>
                        Edit
                      </Button>
                    </div>
                  </Col>
                ...
                {editSurname && <Form.Group as={Row} className="mb-3" controlId="inputName">
                  ...
                  <Col sm={8}>
                    <div className="d-flex align-items-center">
                      ...
                      <Button variant="danger" size="sm" className="ms-2" onClick={() => {setSurname(me.surname); setEditSurname(false);}}>
                        Cancel
                      </Button>
                    </div>
                  </Col>
